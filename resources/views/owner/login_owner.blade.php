...
<body>
    ...
    @if (session()->has('title'))
        <div class="flash-data" data-aksi="Login" data-halaman="Admin" data-title="{{ session('title') }}">
        </div>
    @endif
                    ...
                    <div
                        ...
                        <div class="card card-maroon pt-2">
                            <div class="card-header justify-content-center">
                                <h3 class="text-maroon">Masuk Owner</h3>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('authenticateOwner') }}" class="needs-validation"
                                    novalidate="">
                                    @csrf
