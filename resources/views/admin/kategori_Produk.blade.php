...
@section('konten')
    @if (session()->has('aksi'))
        <div class="flash-data" data-title="Berhasil" data-aksi="{{ session('aksi') }}" data-halaman="Kategori Produk">
        </div>
    @elseif(session()->has('gagal hapus'))
        <div class="flash-data" data-title="{{ session('gagal hapus') }}" data-aksi=".." data-halaman="Kategori Produk">
        </div>
    @endif

    @error('nama_kategori_produk')
        <div class="flash-data" data-title="Gagal" data-aksi="Menambahkan" data-halaman="Kategori Produk">
        </div>
    @enderror
    <!-- Modal Tambah -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/kategori-produk/store" method="POST">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="row mb-2">
        <div class="col-6 col-md-6 col-lg-6">
            <h3 class="text-dark">Daftar Kategori Produk</h3>
        </div>
